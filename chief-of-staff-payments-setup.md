# Chief of Staff AI Payment Setup

Fastest way (no code edits):
...
- `chief-of-staff-launch.html`
- `chief-of-staff-thank-you.html`
...
- The waitlist form now posts to FormSubmit and sends submissions to `muchangasethu0@gmail.com`.
- On first submission, FormSubmit may send a confirmation email to activate delivery.
