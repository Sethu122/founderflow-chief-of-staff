...
## 3) Form submissions (waitlist)

- The waitlist form submits via FormSubmit to `muchangasethu0@gmail.com`.
- If this is your first FormSubmit submission, activate it from the confirmation email they send.
